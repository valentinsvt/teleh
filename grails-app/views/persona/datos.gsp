    ...
    <div class="row-fluid">
        <div class="span10">
            <div class="control-group span10">
                ...
                <span class="control-label label label-inverse span7" style="margin-right: 37px">
                    Trabajo comunitario, pertenece y participa activamente en alguna <br/>organización activista o de dirigencia comunitaria o social
                </span>
