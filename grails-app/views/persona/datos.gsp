        ...
        <div class="span5">
            <div class="control-group">
                ...
                <div class="controls" id="div_canton">
                    <g:select name="canton.id" from="${teleh.Canton.list()}" optionKey="id" class="many-to-one  required"
        ...
        <div class="span5">
            <div class="control-group">
                ...
                <div class="controls" id="div_parr">
                    <g:select name="parroquia.id" from="${teleh.Parroquia.list()}" optionKey="id" class="many-to-one "
