    ...
    <body>
        <div class="container ui-corner-all" style="width: 600px;min-height: 600px;float: left;margin: 20px;border: 1px #aaa solid;padding: 10px;position: relative;">
            ...
            <p style="font-size: 16px;text-align: justify;margin-top: 10px">
                ...
                Para continuar con el proceso por favor ingrese <a href="http://127.0.0.1:8080/login/postulante" target="_blank">AQUI</a> con la información
            que le fue proporcionada anteriormente y cargue el archivo de su título.
                <br/>
                <br/>
