...
<body>
<div style="border: 1px solid #525E67;background: #E0E0E0;color: #939Aa2;width: 300px;position: relative;padding: 10px;height: 400px;margin: 0px;" class="ui-corner-all">

<g:form class="well form-horizontal  " action="validar" name="frmLogin" style="background: none;border: none !important;padding-left: 0px;margin-left: 20px" >
    <p class=" tituloGrande" style="float:left;font-family: 'Tulpen One',cursive;font-weight: bold;font-size: 35px;width: 95%">Sistema </p>

    %{--<div class="linea" style="height: 95%;left: 45px"></div>--}%
    <fieldset style="background: none;margin: 0px;border: none">
